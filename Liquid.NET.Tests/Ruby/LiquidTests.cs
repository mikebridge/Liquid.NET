...
%}", @"{}", @"0 1 2 3")]
        ...
        [TestCase(@"{{ procs | map: ""test"" }}", @"{""procs"":[""#<Proc:0x00000001443b70@/home/bridge/work/liquid/test/integration/standard_filter_test.rb:223>""]}", @"testfoo")]
...
c")]
        ...
        [TestCase(@"{{ foo | first }}", @"{""foo"":[""#<ThingWithToLiquid:0x00000001d41010>""]}", @"foobar")]
        [TestCase(@"{{ foo | last }}", @"{""foo"":[""#<ThingWithToLiquid:0x00000001d32100>""]}", @"foobar")]
...
<tr class=""row2""><td class=""col1""> 6 </td></tr>")]
        [TestCase(@"{{ foo }}", @"{""foo"":""#<ThingWithToLiquid:0x000000016a0a30>""}", @"foobar")]
        [TestCase(@"{% continue %}", @"{}", @"")]
