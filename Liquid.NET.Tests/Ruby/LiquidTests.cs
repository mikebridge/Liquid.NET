...
namespace Liquid.NET.Tests.Ruby
{
    ...
    public class LiquidTests {
        ...
        [TestCase(@"{{ foo | sort: ""bar"" | map: ""foo"" }}", @"{""foo"":""TestEnumerable""}", @"213")]
        [TestCase(@"{{ procs | map: ""test"" }}", @"{""procs"":[""#<Proc:0x000000011ddd40@/home/bridge/work/liquid/test/integration/standard_filter_test.rb:215>""]}", @"testfoo")]
...
c")]
        ...
        [TestCase(@"{{ foo | map: ""foo"" }}", @"{""foo"":""TestEnumerable""}", @"123")]
        ...
        [TestCase(@"{{ foo | first }}", @"{""foo"":[""#<ThingWithToLiquid:0x000000010c1470>""]}", @"foobar")]
        [TestCase(@"{{ foo | last }}", @"{""foo"":[""#<ThingWithToLiquid:0x000000010bf7d8>""]}", @"foobar")]
...
<tr class=""row2""><td class=""col1""> 6 </td></tr>")]
        ...
        [TestCase(@"{% tablerow n in numbers cols:3%} {{n}} {% endtablerow %}", @"{""numbers"":""TableRowTest::ArrayDrop""}", @"<tr class=""row1"">
<td class=""col1""> 1 </td><td class=""col2""> 2 </td><td class=""col3""> 3 </td></tr>
<tr class=""row2""><td class=""col1""> 4 </td><td class=""col2""> 5 </td><td class=""col3""> 6 </td></tr>")]
...
<tr class=""row2""><td class=""col1""> 4 </td><td class=""col2""> 5 </td><td class=""col3""> 6 </td></tr>")]
        ...
        [TestCase(@"{{ foo }}", @"{""foo"":""#<ThingWithToLiquid:0x000000011e8920>""}", @"foobar")]
        [TestCase(@"{% break %}", @"{""i"":1}", @"")]
      ...
      next")]
        ...
        [TestCase(@"{% for item in items offset:2 limit:2 %}{{item}}{% endfor %}", @"{""items"":""ForTagTest::LoaderDrop""}", @"34")]
        ...
        [TestCase(@"{%for item in (1..foobar.value) %} {{item}} {%endfor%}", @"{""foobar"":""ThingWithValue""}", @"1  2  3")]
        [TestCase(@"{%for i in array.items limit:3 %}{{i}}{%endfor%}
      next
      {%for i in array.items offset:continue limit:3 %}{{i}}{%endfor%}
      next
      ...
      7")]
        ...
        [TestCase(@"{% for item in items %}{{item}}{% endfor %}", @"{""items"":""ForTagTest::LoaderDrop""}", @"12345")]
      ...
      next
      789")]
        [TestCase(@"{% for item in items limit:1 %}{{item}}{% endfor %}", @"{""items"":""ForTagTest::LoaderDrop""}", @"1")]
