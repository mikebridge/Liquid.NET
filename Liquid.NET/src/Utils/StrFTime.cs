...
namespace Liquid.NET.Utils
{
    ...
    /// <summary>
    /// See: https://github.com/mikebridge/dotliquid/blob/master/src/DotLiquid/Util/StrFTime.cs
    /// </summary>
    public static class StrFTime
    {

        private static readonly Dictionary<string, Func<DateTime, string>> Formats = new Dictionary<string, Func<DateTime, string>>
		{
        ...
        private static String StrFTimeMatchEvaluator(
            String orig, 
            ...
            DateTime datetime)
        {
            ...
            {
                var result = Formats[directive](datetime);
